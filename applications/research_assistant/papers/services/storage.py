...
from applications.research_assistant.papers.config import PAPER_STORAGE_PATH
from applications.research_assistant.papers.entities import DocumentChunk, Paper
from applications.research_assistant.papers.interfaces import PaperRepository
